//Test client for Homework 1 in CSC 2431
//Turn in output after running this *unmodified*
//client (and please also turn in a copy of the client).
#include <iostream>
using namespace std;
...
int main()
{
	...
	//create a copy of 5-element list (first)
	doublyLinkedList second(first);

	//test all 3 cases for delete (first, last, somewhere in the middle)

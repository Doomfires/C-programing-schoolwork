// Header file for doublyLinkedList, a pointer-based *sorted* by-position list of type
...
public:
	...
	//Parameters: the list to compare to this (doublyLinkedList)
	...
	//Reverses the traversing of the doubly linked list
	void doublyLinkedList::reverse();

	//Prints out the list from front to back
	void doublyLinkedList::printFront()const;

	//Prints out the list from back to front
...
private:
	...
	listNode *head;  // pointer to front of linked list of items
